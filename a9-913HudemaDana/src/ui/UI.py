        ...
        while True:
            ...
            if cmd1 == '0':
                ...
                try:
                    ...
                    self.ur.add_to_undo_list(
                        [partial(self.sp.remove_person, id), partial(self.sp.add_new_person, id, name, phone), item, id])
                except ServicePersonException as sp:
                    print(sp)
        ...
        while True:
            ...
            if cmd2 == '0':
                ...
                try:
                    ...
                    self.ur.add_to_undo_list([partial(self.sa.add_activity_to_person,activity_id,person_id),partial(self.sa.remove_activity_from_person,activity_id,person_id)])
                except ServiceActivityException as ss:
                    print(ss)
