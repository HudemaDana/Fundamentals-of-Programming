...
class RepoPerson:
    ...
    def __init__(self, repo_activity):
        self._pers_data = IteratorStructure()
    ...
    def add_person(self, person):
        ...
        """
        self._pers_data.list.append([person.person_id, person.name, person.phone_number][:])

    @property
    def person_repo(self):
        return self._pers_data.list
    ...
    def random_generate(self):
        ...
        for i in range(20):
            ...
            while ok:
                ok = 0
                for j in range(0, len(self._pers_data.list)):
