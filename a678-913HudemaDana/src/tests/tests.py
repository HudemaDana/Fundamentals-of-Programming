...
class TestActivity(unittest.TestCase):
    ...
    def test_date(self):
        new_activity = [Activity(10, "10.02.2021", '12.00-16.00', "tennis club", [2, 3, 4]),Activity(11, "10.02.2021", '12.00-16.00', "tennis club", [2, 3, 4])]
        self.assertEqual(new_activity[0].date, "10.02.2021")
