...
from src.iterator_struct.Iterator_module import gnomeSort
...
class ServiceActivity:
    ...
    def cond_sort1(self, list, index):
        if self.transform_st_time(list[index][2]) >= self.transform_st_time(list[index - 1][2]):
            return True
        return False
    ...
    def sort_activities_by_st_time(self, list):
        ...
        """
        l = gnomeSort(list, self.cond_sort1)
        return l
    ...
    def condition_sort(self, list, index):
    ...
    def sort_after_free_time(self, list):
        ...
        """
        l = gnomeSort(list, self.condition_sort)
        return l
